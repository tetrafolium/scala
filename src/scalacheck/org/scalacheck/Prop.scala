...
sealed abstract class Prop extends Serializable { self =>
  ...
  def ==>(p: => Prop): Prop = flatMap { r1 =>
    if (r1.proved) p map { r2 =>
      mergeRes(r1, r2, r2.status)
    } else if (!r1.success) Prop(r1.copy(status = Undecided))
    else
      p map { r2 =>
        provedToTrue(mergeRes(r1, r2, r2.status))
      }
  }
...
object Prop {
  ...
  def apply(f: Parameters => Result): Prop =
    new PropFromFun(
      prms =>
        try f(prms)
        catch {
  ...
  implicit def AnyOperators[T](x: => T)(implicit ev: T => Pretty) =
    new ExtendedAny[T](x)
  ...
  def exists[A, P](f: A => P)(implicit
                              pv: P => Prop,
                              pp: A => Pretty,
                              aa: Arbitrary[A]): Prop = exists(aa.arbitrary)(f)
  ...
  /** Universal quantifier for an explicit generator. Does not shrink failed
    *  test cases. */
  def forAllNoShrink[T1, P](g1: Gen[T1])(f: T1 => P)(implicit
                                                     pv: P => Prop,
                                                     pp1: T1 => Pretty): Prop =
    Prop { prms0 =>
      val (prms, seed) = startSeed(prms0)
      ...
      gr.retrieve match {
        ...
        case Some(x) =>
          ...
          provedToTrue(p(slideSeed(prms0)))
            .addArg(Arg(labels, x, 0, x, pp1(x), pp1(x)))
      }
    }

  /** Universal quantifier for two explicit generators.
    *  Does not shrink failed test cases. */
  def forAllNoShrink[T1, T2, P](g1: Gen[T1], g2: Gen[T2])(f: (T1, T2) => P)(
      implicit
      p: P => Prop,
      pp1: T1 => Pretty,
      pp2: T2 => Pretty): Prop =
    forAllNoShrink(g1)(t => forAllNoShrink(g2)(f(t, _: T2)))

  /** Universal quantifier for three explicit generators.
    *  Does not shrink failed test cases. */
  def forAllNoShrink[T1, T2, T3, P](g1: Gen[T1], g2: Gen[T2], g3: Gen[T3])(
      f: (T1, T2, T3) => P)(implicit
                            p: P => Prop,
                            pp1: T1 => Pretty,
                            pp2: T2 => Pretty,
                            pp3: T3 => Pretty): Prop =
    forAllNoShrink(g1)(t => forAllNoShrink(g2, g3)(f(t, _: T2, _: T3)))

  /** Universal quantifier for four explicit generators.
    *  Does not shrink failed test cases. */
  def forAllNoShrink[T1, T2, T3, T4, P](g1: Gen[T1],
                                        g2: Gen[T2],
                                        g3: Gen[T3],
                                        g4: Gen[T4])(f: (T1, T2, T3, T4) => P)(
      implicit
      p: P => Prop,
      pp1: T1 => Pretty,
      pp2: T2 => Pretty,
      ...
      pp4: T4 => Pretty): Prop =
    forAllNoShrink(g1)(t =>
      forAllNoShrink(g2, g3, g4)(f(t, _: T2, _: T3, _: T4)))
  ...
  def forAllNoShrink[T1, T2, T3, T4, T5, P](
      ...
      g3: Gen[T3],
      g4: Gen[T4],
      g5: Gen[T5])(f: (T1, T2, T3, T4, T5) => P)(implicit
                                                 p: P => Prop,
                                                 pp1: T1 => Pretty,
                                                 pp2: T2 => Pretty,
                                                 pp3: T3 => Pretty,
                                                 ...
                                                 pp5: T5 => Pretty): Prop =
    forAllNoShrink(g1)(t =>
      forAllNoShrink(g2, g3, g4, g5)(f(t, _: T2, _: T3, _: T4, _: T5)))
  ...
  def forAllNoShrink[T1, T2, T3, T4, T5, T6, P](
      ...
      g4: Gen[T4],
      g5: Gen[T5],
      g6: Gen[T6])(f: (T1, T2, T3, T4, T5, T6) => P)(implicit
                                                     p: P => Prop,
                                                     pp1: T1 => Pretty,
                                                     pp2: T2 => Pretty,
                                                     pp3: T3 => Pretty,
    ...
    forAllNoShrink(g1)(
      t =>
        forAllNoShrink(g2, g3, g4, g5, g6)(
          f(t, _: T2, _: T3, _: T4, _: T5, _: T6)))
  ...
  def forAllNoShrink[T1, T2, T3, T4, T5, T6, T7, P](
      ...
      g5: Gen[T5],
      g6: Gen[T6],
      g7: Gen[T7])(f: (T1, T2, T3, T4, T5, T6, T7) => P)(
      implicit
      p: P => Prop,
      pp1: T1 => Pretty,
      pp2: T2 => Pretty,
    ...
    forAllNoShrink(g1)(
      t =>
        forAllNoShrink(g2, g3, g4, g5, g6, g7)(
          f(t, _: T2, _: T3, _: T4, _: T5, _: T6, _: T7)))
  ...
  def forAllNoShrink[T1, T2, T3, T4, T5, T6, T7, T8, P](
      ...
      g6: Gen[T6],
      g7: Gen[T7],
      g8: Gen[T8])(f: (T1, T2, T3, T4, T5, T6, T7, T8) => P)(
      implicit
      p: P => Prop,
      pp1: T1 => Pretty,
      pp2: T2 => Pretty,
    ...
    forAllNoShrink(g1)(
      t =>
        forAllNoShrink(g2, g3, g4, g5, g6, g7, g8)(
          f(t, _: T2, _: T3, _: T4, _: T5, _: T6, _: T7, _: T8)))

  /** Converts a function into a universally quantified property */
  def forAllNoShrink[A1, P](f: A1 => P)(implicit
                                        pv: P => Prop,
                                        a1: Arbitrary[A1],
                                        pp1: A1 => Pretty): Prop =
    forAllNoShrink(arbitrary[A1])(f)

  /** Converts a function into a universally quantified property */
  def forAllNoShrink[A1, A2, P](f: (A1, A2) => P)(implicit
                                                  pv: P => Prop,
                                                  a1: Arbitrary[A1],
                                                  pp1: A1 => Pretty,
                                                  a2: Arbitrary[A2],
                                                  pp2: A2 => Pretty): Prop =
    forAllNoShrink(arbitrary[A1], arbitrary[A2])(f)

  /** Converts a function into a universally quantified property */
  def forAllNoShrink[A1, A2, A3, P](f: (A1, A2, A3) => P)(
      implicit
      pv: P => Prop,
      a1: Arbitrary[A1],
      pp1: A1 => Pretty,
      ...
      a3: Arbitrary[A3],
      pp3: A3 => Pretty): Prop =
    forAllNoShrink(arbitrary[A1], arbitrary[A2], arbitrary[A3])(f)

  /** Converts a function into a universally quantified property */
  def forAllNoShrink[A1, A2, A3, A4, P](f: (A1, A2, A3, A4) => P)(
      implicit
      pv: P => Prop,
      a1: Arbitrary[A1],
      pp1: A1 => Pretty,
      ...
      a4: Arbitrary[A4],
      pp4: A4 => Pretty): Prop =
    forAllNoShrink(arbitrary[A1], arbitrary[A2], arbitrary[A3], arbitrary[A4])(
      f)

  /** Converts a function into a universally quantified property */
  def forAllNoShrink[A1, A2, A3, A4, A5, P](f: (A1, A2, A3, A4, A5) => P)(
      implicit
      pv: P => Prop,
      a1: Arbitrary[A1],
      pp1: A1 => Pretty,
  ...
  def forAllShrink[T, P](g: Gen[T], shrink: T => Stream[T])(
      f: T => P)(implicit pv: P => Prop, pp: T => Pretty): Prop = Prop {
    prms0 =>
      val (prms, seed) = startSeed(prms0)
      val gr = g.doApply(prms, seed)
      val labels = gr.labels.mkString(",")
      ...
      def shrinker(x: T, r: Result, shrinks: Int, orig: T): Result = {
        ...
        if (xs.isEmpty) res
          ...
          getFirstFailure(xs) match {
            case Right((x2, r2)) => res
            case Left((x2, r2)) =>
              shrinker(x2, replOrig(r, r2), shrinks + 1, orig)
          }
      }
  ...
  def forAll[T1, P](g1: Gen[T1])(f: T1 => P)(implicit
                                             p: P => Prop,
                                             s1: Shrink[T1],
                                             pp1: T1 => Pretty): Prop =
    forAllShrink[T1, P](g1, shrink[T1])(f)

  /** Universal quantifier for two explicit generators. Shrinks failed arguments
    *  with the default shrink function for the type */
  def forAll[T1, T2, P](g1: Gen[T1], g2: Gen[T2])(f: (T1, T2) => P)(
      implicit
      p: P => Prop,
      s1: Shrink[T1],
      pp1: T1 => Pretty,
      s2: Shrink[T2],
      pp2: T2 => Pretty): Prop = forAll(g1)(t => forAll(g2)(f(t, _: T2)))
  ...
  def forAll[T1, T2, T3, T4, P](g1: Gen[T1],
      ...
      s4: Shrink[T4],
      pp4: T4 => Pretty): Prop =
    forAll(g1)(t => forAll(g2, g3, g4)(f(t, _: T2, _: T3, _: T4)))

  /** Universal quantifier for five explicit generators. Shrinks failed arguments
    *  with the default shrink function for the type */
  def forAll[T1, T2, T3, T4, T5, P](g1: Gen[T1],
                                    g2: Gen[T2],
                                    g3: Gen[T3],
                                    g4: Gen[T4],
                                    g5: Gen[T5])(f: (T1, T2, T3, T4, T5) => P)(
      implicit
      p: P => Prop,
      s1: Shrink[T1],
      pp1: T1 => Pretty,
      ...
      s5: Shrink[T5],
      pp5: T5 => Pretty): Prop =
    forAll(g1)(t => forAll(g2, g3, g4, g5)(f(t, _: T2, _: T3, _: T4, _: T5)))
  ...
  def forAll[T1, T2, T3, T4, T5, T6, P](
      ...
      g6: Gen[T6])(f: (T1, T2, T3, T4, T5, T6) => P)(implicit
                                                     ...
                                                     pp6: T6 => Pretty): Prop =
    forAll(g1)(t =>
      forAll(g2, g3, g4, g5, g6)(f(t, _: T2, _: T3, _: T4, _: T5, _: T6)))
  ...
  /** Converts a function into a universally quantified property */
  def forAll[A1, A2, P](f: (A1, A2) => P)(implicit
                                          p: P => Prop,
                                          a1: Arbitrary[A1],
                                          s1: Shrink[A1],
                                          pp1: A1 => Pretty,
                                          ...
                                          s2: Shrink[A2],
                                          pp2: A2 => Pretty): Prop =
    forAll((a: A1) => forAll(f(a, _: A2)))

  /** Converts a function into a universally quantified property */
  def forAll[A1, A2, A3, P](f: (A1, A2, A3) => P)(implicit
                                                  p: P => Prop,
                                                  a1: Arbitrary[A1],
                                                  s1: Shrink[A1],
                                                  pp1: A1 => Pretty,
                                                  ...
                                                  s3: Shrink[A3],
                                                  pp3: A3 => Pretty): Prop =
    forAll((a: A1) => forAll(f(a, _: A2, _: A3)))
  ...
  def forAll[A1, A2, A3, A4, P](f: (A1, A2, A3, A4) => P)(
      ...
      s4: Shrink[A4],
      pp4: A4 => Pretty): Prop =
    forAll((a: A1) => forAll(f(a, _: A2, _: A3, _: A4)))
  ...
  def forAll[A1, A2, A3, A4, A5, P](f: (A1, A2, A3, A4, A5) => P)(
      ...
      s5: Shrink[A5],
      pp5: A5 => Pretty): Prop =
    forAll((a: A1) => forAll(f(a, _: A2, _: A3, _: A4, _: A5)))
  ...
  def forAll[A1, A2, A3, A4, A5, A6, P](f: (A1, A2, A3, A4, A5, A6) => P)(
      ...
      s6: Shrink[A6],
      pp6: A6 => Pretty): Prop =
    forAll((a: A1) => forAll(f(a, _: A2, _: A3, _: A4, _: A5, _: A6)))
  ...
  def forAll[A1, A2, A3, A4, A5, A6, A7, P](
      f: (A1, A2, A3, A4, A5, A6, A7) => P)(implicit
                                            ...
                                            s7: Shrink[A7],
                                            pp7: A7 => Pretty): Prop =
    forAll((a: A1) => forAll(f(a, _: A2, _: A3, _: A4, _: A5, _: A6, _: A7)))
  ...
  def forAll[A1, A2, A3, A4, A5, A6, A7, A8, P](
      f: (A1, A2, A3, A4, A5, A6, A7, A8) => P)(implicit
                                                ...
                                                pp8: A8 => Pretty): Prop =
    forAll(
      (a: A1) => forAll(f(a, _: A2, _: A3, _: A4, _: A5, _: A6, _: A7, _: A8)))
  ...
  def within(maximumMs: Long)(wrappedProp: => Prop): Prop = {
    @tailrec def attempt(prms: Parameters, endTime: Long): Result = {
      ...
      if (System.currentTimeMillis > endTime) {
        (if (result.failure) result else Result(status = False))
          .label("Timeout")
      } else {
