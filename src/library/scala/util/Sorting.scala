...
object Sorting {
  ...
  private def mergeSorted[@specialized T](a: Array[T],
                                          i0: Int,
                                          iK: Int,
                                          iN: Int,
                                          ord: Ordering[T],
  ...
  def stableSort[K: ClassTag: Ordering](
      a: scala.collection.Seq[K]): Array[K] = {
    val ret = a.toArray
    sort(ret, Ordering[K])
    ret
  }
  ...
  def stableSort[K: ClassTag](a: scala.collection.Seq[K],
                              f: (K, K) => Boolean): Array[K] = {
    val ret = a.toArray
  ...
  def stableSort[K: ClassTag, M: Ordering](a: scala.collection.Seq[K],
                                           f: K => M): Array[K] = {
    val ret = a.toArray
