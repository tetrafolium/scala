...
object Function {
  ...
  /** Given a sequence of functions `f,,1,,`, ..., `f,,n,,`, return the
    ...
    */
  def chain[T](fs: scala.collection.Seq[T => T]): T => T = { x =>
  ...
  /** Uncurrying for functions of arity 2. This transforms a unary function
    ...
    */
  def uncurried[T1, T2, R](f: T1 => T2 => R): (T1, T2) => R = { (x1, x2) =>
    f(x1)(x2)
  }
  ...
  /** Uncurrying for functions of arity 4.
    */
  def uncurried[T1, T2, T3, T4, R](
      f: T1 => T2 => T3 => T4 => R): (T1, T2, T3, T4) => R = {
    (x1, x2, x3, x4) =>
      f(x1)(x2)(x3)(x4)
  }
  ...
  /** Uncurrying for functions of arity 5.
    */
  def uncurried[T1, T2, T3, T4, T5, R](
  ...
  /** Un-tupling for functions of arity 2. This transforms a function taking
    ...
    */
  def untupled[T1, T2, R](f: ((T1, T2)) => R): (T1, T2) => R = { (x1, x2) =>
    f((x1, x2))
  }
  ...
  /** Un-tupling for functions of arity 4. This transforms a function taking
    ...
    */
  def untupled[T1, T2, T3, T4, R](
      f: ((T1, T2, T3, T4)) => R): (T1, T2, T3, T4) => R = { (x1, x2, x3, x4) =>
    f((x1, x2, x3, x4))
  }
