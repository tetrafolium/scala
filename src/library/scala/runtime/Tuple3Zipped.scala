...
object ZippedIterable3 {
  implicit def zippedIterable3ToIterable[El1, El2, El3](
      zz: ZippedIterable3[El1, El2, El3]): Iterable[(El1, El2, El3)] = {
...
@deprecated("Use scala.collection.LazyZip3.", "2.13.0")
final class Tuple3Zipped[El1, It1 <: Iterable[El1], El2, It2 <: Iterable[El2],
El3, It3 <: Iterable[El3]](private val colls: (It1, It2, It3))
    extends AnyVal
    with ZippedIterable3[El1, El2, El3] {
  ...
  def map[B, To](f: (El1, El2, El3) => B)(
      implicit bf: BuildFrom[It1, B, To]): To = {
  ...
  def flatMap[B, To](f: (El1, El2, El3) => IterableOnce[B])(
      implicit bf: BuildFrom[It1, B, To]): To = {
    val b = bf.newBuilder(coll1)
    val elems1 = coll1.iterator
    val elems2 = coll2.iterator
  ...
  def iterator: Iterator[(El1, El2, El3)] =
    coll1.iterator.zip(coll2.iterator).zip(coll3.iterator).map {
      case ((a, b), c) => (a, b, c)
    }
...
object Tuple3Zipped {
  final class Ops[T1, T2, T3](private val x: (T1, T2, T3)) extends AnyVal {
    def invert[El1,
               ...
               El3,
               It3 <: Iterable[El3],
               That](implicit w1: T1 <:< It1,
                     w2: T2 <:< It2,
                     w3: T3 <:< It3,
                     bf: BuildFrom[It1, (El1, El2, El3), That]): That = {
      val buf = bf.newBuilder(x._1)
      val it1 = x._1.iterator
      val it2 = x._2.iterator
      val it3 = x._3.iterator
      while (it1.hasNext && it2.hasNext && it3.hasNext) buf += ((it1.next(),
                                                                 it2.next(),
                                                                 it3.next()))
    ...
    def zipped[El1,
      ...
      : Tuple3Zipped[El1, It1, El2, It2, El3, It3] =
      new Tuple3Zipped((w1(x._1), w2(x._2), w3(x._3)))
  }
}
