...
object ZippedIterable2 {
  implicit def zippedIterable2ToIterable[El1, El2](
      zz: ZippedIterable2[El1, El2]): Iterable[(El1, El2)] = {
...
@deprecated("Use scala.collection.LazyZip2.", "2.13.0")
final class Tuple2Zipped[El1, It1 <: Iterable[El1], El2, It2 <: Iterable[El2]](
    private val colls: (It1, It2))
    extends AnyVal
    with ZippedIterable2[El1, El2] {
  ...
  def flatMap[B, To](f: (El1, El2) => IterableOnce[B])(
  ...
  def filter[To1, To2](f: (El1, El2) => Boolean)(
      ...
      bf2: BuildFrom[It2, El2, To2]): (To1, To2) = {
...
object Tuple2Zipped {
  final class Ops[T1, T2](private val x: (T1, T2)) extends AnyVal {
    def invert[El1, It1 <: Iterable[El1], El2, It2 <: Iterable[El2], That](
        implicit w1: T1 <:< It1,
        w2: T2 <:< It2,
        bf: BuildFrom[It1, (El1, El2), That]): That = {
    ...
    def zipped[El1, It1 <: Iterable[El1], El2, It2 <: Iterable[El2]](
      ...
      : Tuple2Zipped[El1, It1, El2, It2] =
      new Tuple2Zipped((w1(x._1), w2(x._2)))
  }
}
