...
object BigDecimal {
  ...
  private[this] lazy val cache =
    new Array[BigDecimal](maxCached - minCached + 1)
  ...
  def decimal(bd: BigDec, mc: MathContext): BigDecimal =
    new BigDecimal(bd.round(mc), mc)
  ...
  def binary(d: Double, mc: MathContext): BigDecimal =
    new BigDecimal(new BigDec(d, mc), mc)
...
final class BigDecimal(val bigDecimal: BigDec, val mc: MathContext)
  ...
  /** Subtraction of BigDecimals
    */
  def -(that: BigDecimal): BigDecimal =
    new BigDecimal(this.bigDecimal.subtract(that.bigDecimal, mc), mc)
  ...
  def remainder(that: BigDecimal): BigDecimal =
    new BigDecimal(this.bigDecimal.remainder(that.bigDecimal, mc), mc)
  ...
  def until(end: BigDecimal, step: BigDecimal) =
  ...
  /** Like `until`, but inclusive of the end value. */
  def to(end: BigDecimal, step: BigDecimal) =
    Range.BigDecimal.inclusive(this, end, step)
