...
trait LowPriorityEquiv {
  ...
  /**
    ...
    */
  @deprecated(
    "Use explicit Equiv.universal instead. See Scaladoc entry for more information: " +
...
object Equiv extends LowPriorityEquiv {
  ...
  def fromComparator[T](cmp: Comparator[T]): Equiv[T] = { (x, y) =>
    cmp.compare(x, y) == 0
  }
  def fromFunction[T](cmp: (T, T) => Boolean): Equiv[T] = { (x, y) =>
    cmp(x, y)
  }
  ...
  private final class IterableEquiv[CC[X] <: Iterable[X], T](
      private val eqv: Equiv[T])
      extends Equiv[CC[T]] {
  ...
  trait ExtraImplicits {
    ...
    /** Not in the standard scope due to the potential for divergence:
      ...
      */
    implicit def seqEquiv[CC[X] <: scala.collection.Seq[X], T](
        implicit eqv: Equiv[T]): Equiv[CC[T]] =
      new IterableEquiv[CC, T](eqv)

    implicit def sortedSetEquiv[CC[X] <: scala.collection.SortedSet[X], T](
        implicit eqv: Equiv[T]): Equiv[CC[T]] =
      new IterableEquiv[CC, T](eqv)
  }
  ...
  @deprecated(
    "There are multiple equivalences for Floats (Equiv.Float.TotalEquiv, " +
  ...
  @deprecated(
    "There are multiple equivalences for Doubles (Equiv.Double.TotalEquiv, " +
  ...
  private[this] final class OptionEquiv[T](private val eqv: Equiv[T])
      extends Equiv[Option[T]] {
  ...
  implicit def Tuple2[T1, T2](implicit eqv1: Equiv[T1],
                              eqv2: Equiv[T2]): Equiv[(T1, T2)] =
  ...
  implicit def Tuple3[T1, T2, T3](implicit eqv1: Equiv[T1],
                                  eqv2: Equiv[T2],
                                  eqv3: Equiv[T3]): Equiv[(T1, T2, T3)] =
  ...
  implicit def Tuple4[T1, T2, T3, T4](
      implicit eqv1: Equiv[T1],
      eqv2: Equiv[T2],
      eqv3: Equiv[T3],
      eqv4: Equiv[T4]): Equiv[(T1, T2, T3, T4)] =
    new Tuple4Equiv(eqv1, eqv2, eqv3, eqv4)

  private[this] final class Tuple4Equiv[T1, T2, T3, T4](
      private val eqv1: Equiv[T1],
      private val eqv2: Equiv[T2],
      private val eqv3: Equiv[T3],
  ...
  implicit def Tuple5[T1, T2, T3, T4, T5](
      ...
      eqv3: Equiv[T3],
      eqv4: Equiv[T4],
      eqv5: Equiv[T5]): Equiv[(T1, T2, T3, T4, T5)] =
    new Tuple5Equiv(eqv1, eqv2, eqv3, eqv4, eqv5)

  private[this] final class Tuple5Equiv[T1, T2, T3, T4, T5](
      private val eqv1: Equiv[T1],
      private val eqv2: Equiv[T2],
      private val eqv3: Equiv[T3],
      private val eqv4: Equiv[T4],
  ...
  implicit def Tuple6[T1, T2, T3, T4, T5, T6](
      ...
      eqv4: Equiv[T4],
      eqv5: Equiv[T5],
      eqv6: Equiv[T6]): Equiv[(T1, T2, T3, T4, T5, T6)] =
    new Tuple6Equiv(eqv1, eqv2, eqv3, eqv4, eqv5, eqv6)

  private[this] final class Tuple6Equiv[T1, T2, T3, T4, T5, T6](
      private val eqv1: Equiv[T1],
      private val eqv2: Equiv[T2],
      private val eqv3: Equiv[T3],
      private val eqv4: Equiv[T4],
    ...
    def equiv(x: (T1, T2, T3, T4, T5, T6),
              y: (T1, T2, T3, T4, T5, T6)): Boolean =
      eqv1.equiv(x._1, y._1) &&
        eqv2.equiv(x._2, y._2) &&
        eqv3.equiv(x._3, y._3) &&
        eqv4.equiv(x._4, y._4) &&
    ...
    override def hashCode(): Int =
      (eqv1, eqv2, eqv3, eqv4, eqv5, eqv6).hashCode()
  }
  ...
  implicit def Tuple7[T1, T2, T3, T4, T5, T6, T7](
      ...
      eqv5: Equiv[T5],
      eqv6: Equiv[T6],
      eqv7: Equiv[T7]): Equiv[(T1, T2, T3, T4, T5, T6, T7)] =
    new Tuple7Equiv(eqv1, eqv2, eqv3, eqv4, eqv5, eqv6, eqv7)

  private[this] final class Tuple7Equiv[T1, T2, T3, T4, T5, T6, T7](
      private val eqv1: Equiv[T1],
      private val eqv2: Equiv[T2],
      private val eqv3: Equiv[T3],
      private val eqv4: Equiv[T4],
    ...
    def equiv(x: (T1, T2, T3, T4, T5, T6, T7),
              y: (T1, T2, T3, T4, T5, T6, T7)): Boolean =
      eqv1.equiv(x._1, y._1) &&
        eqv2.equiv(x._2, y._2) &&
        eqv3.equiv(x._3, y._3) &&
        eqv4.equiv(x._4, y._4) &&
    ...
    override def hashCode(): Int =
      (eqv1, eqv2, eqv3, eqv4, eqv5, eqv6, eqv7).hashCode()
  }
  ...
  implicit def Tuple8[T1, T2, T3, T4, T5, T6, T7, T8](
      ...
      eqv6: Equiv[T6],
      eqv7: Equiv[T7],
      eqv8: Equiv[T8]): Equiv[(T1, T2, T3, T4, T5, T6, T7, T8)] =
    new Tuple8Equiv(eqv1, eqv2, eqv3, eqv4, eqv5, eqv6, eqv7, eqv8)

  private[this] final class Tuple8Equiv[T1, T2, T3, T4, T5, T6, T7, T8](
      private val eqv1: Equiv[T1],
      private val eqv2: Equiv[T2],
      private val eqv3: Equiv[T3],
      private val eqv4: Equiv[T4],
    ...
    def equiv(x: (T1, T2, T3, T4, T5, T6, T7, T8),
              y: (T1, T2, T3, T4, T5, T6, T7, T8)): Boolean =
      eqv1.equiv(x._1, y._1) &&
        eqv2.equiv(x._2, y._2) &&
        eqv3.equiv(x._3, y._3) &&
        eqv4.equiv(x._4, y._4) &&
    ...
    override def hashCode(): Int =
      (eqv1, eqv2, eqv3, eqv4, eqv5, eqv6, eqv7, eqv8).hashCode()
  }
  ...
  implicit def Tuple9[T1, T2, T3, T4, T5, T6, T7, T8, T9](
      ...
      eqv7: Equiv[T7],
      eqv8: Equiv[T8],
      eqv9: Equiv[T9]): Equiv[(T1, T2, T3, T4, T5, T6, T7, T8, T9)] =
    new Tuple9Equiv(eqv1, eqv2, eqv3, eqv4, eqv5, eqv6, eqv7, eqv8, eqv9)

  private[this] final class Tuple9Equiv[T1, T2, T3, T4, T5, T6, T7, T8, T9](
      private val eqv1: Equiv[T1],
      private val eqv2: Equiv[T2],
      private val eqv3: Equiv[T3],
      private val eqv4: Equiv[T4],
    ...
    def equiv(x: (T1, T2, T3, T4, T5, T6, T7, T8, T9),
              y: (T1, T2, T3, T4, T5, T6, T7, T8, T9)): Boolean =
      eqv1.equiv(x._1, y._1) &&
        eqv2.equiv(x._2, y._2) &&
        eqv3.equiv(x._3, y._3) &&
        eqv4.equiv(x._4, y._4) &&
    ...
    override def hashCode(): Int =
      (eqv1, eqv2, eqv3, eqv4, eqv5, eqv6, eqv7, eqv8, eqv9).hashCode()
  }
