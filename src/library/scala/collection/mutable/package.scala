...
package object mutable {
  @deprecated(
    "Use ArraySeq instead of WrappedArray; it can represent both, boxed and unboxed arrays",
    "2.13.0")
  ...
  @deprecated(
    "Use Stack instead of ArrayStack; it now uses an array-based implementation",
    "2.13.0")
  ...
  @deprecated(
    "mutable.LinearSeq has been removed; use LinearSeq with mutable.Seq instead",
    "2.13.0")
  ...
  @deprecated("IndexedOptimizedBuffer has been renamed to IndexedBuffer",
              "2.13.0")
