...
trait SortedMap[K, V]
  ...
  override def withDefault(d: K => V): SortedMap[K, V] =
    new SortedMap.WithDefault[K, V](this, d)
  ...
  override def withDefaultValue(d: V): SortedMap[K, V] =
    new SortedMap.WithDefault[K, V](this, _ => d)
}
...
trait SortedMapOps[K,
  ...
  @deprecated("Use m.clone().addOne((k,v)) instead of m.updated(k, v)",
              "2.13.0")
...
object SortedMap extends SortedMapFactory.Delegate[SortedMap](TreeMap) {
  ...
  final class WithDefault[K, V](underlying: SortedMap[K, V],
    ...
    override def subtractOne(elem: K): WithDefault.this.type = {
      underlying.subtractOne(elem); this
    }

    override def addOne(elem: (K, V)): WithDefault.this.type = {
