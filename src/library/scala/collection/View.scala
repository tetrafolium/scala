...
object View extends IterableFactory[View] {
  ...
  /** A view that uses a function `f` to produce elements of type `A` and update
    ...
    */
  @SerialVersionUID(3L)
  class Unfold[A, S](initial: S)(f: S => Option[(A, S)])
  ...
  @SerialVersionUID(3L)
  class Filter[A](val underlying: SomeIterableOps[A],
                  val p: A => Boolean,
                  val isFlipped: Boolean)
      extends AbstractView[A] {
    def iterator = underlying.iterator.filterImpl(p, isFlipped)
    override def knownSize: Int =
      if (underlying.knownSize == 0) 0 else super.knownSize
    override def isEmpty: Boolean = iterator.isEmpty
  }

  object Filter {
    def apply[A](underlying: Iterable[A],
                 p: A => Boolean,
                 isFlipped: Boolean): Filter[A] =
      underlying match {
  ...
  @SerialVersionUID(3L)
  class DistinctBy[A, B](underlying: SomeIterableOps[A], f: A => B)
      extends AbstractView[A] {
  ...
  @SerialVersionUID(3L)
  class LeftPartitionMapped[A, A1, A2](underlying: SomeIterableOps[A],
                                       f: A => Either[A1, A2])
  ...
  @SerialVersionUID(3L)
  class RightPartitionMapped[A, A1, A2](underlying: SomeIterableOps[A],
                                        f: A => Either[A1, A2])
  ...
  @SerialVersionUID(3L)
  class Drop[A](underlying: SomeIterableOps[A], n: Int)
      extends AbstractView[A] {
  ...
  @SerialVersionUID(3L)
  class DropRight[A](underlying: SomeIterableOps[A], n: Int)
      extends AbstractView[A] {
  ...
  @SerialVersionUID(3L)
  class DropWhile[A](underlying: SomeIterableOps[A], p: A => Boolean)
      extends AbstractView[A] {
  ...
  @SerialVersionUID(3L)
  class Take[+A](underlying: SomeIterableOps[A], n: Int)
      extends AbstractView[A] {
  ...
  @SerialVersionUID(3L)
  class TakeRight[+A](underlying: SomeIterableOps[A], n: Int)
      extends AbstractView[A] {
  ...
  @SerialVersionUID(3L)
  class TakeWhile[A](underlying: SomeIterableOps[A], p: A => Boolean)
      extends AbstractView[A] {
  ...
  @SerialVersionUID(3L)
  class ScanLeft[+A, +B](underlying: SomeIterableOps[A], z: B, op: (B, A) => B)
  ...
  @SerialVersionUID(3L)
  class Map[+A, +B](underlying: SomeIterableOps[A], f: A => B)
      extends AbstractView[B] {
  ...
  @SerialVersionUID(3L)
  class FlatMap[A, B](underlying: SomeIterableOps[A], f: A => IterableOnce[B])
      extends AbstractView[B] {
  ...
  @SerialVersionUID(3L)
  class Collect[+A, B](underlying: SomeIterableOps[A],
  ...
  /** A view that concatenates elements of the prefix collection or iterator with the elements
    ...
    */
  @SerialVersionUID(3L)
  class Concat[A](prefix: SomeIterableOps[A], suffix: SomeIterableOps[A])
      extends AbstractView[A] {
  ...
  /** A view that zips elements of the underlying collection with the elements
    ...
    */
  @SerialVersionUID(3L)
  class Zip[A, B](underlying: SomeIterableOps[A], other: Iterable[B])
      extends AbstractView[(A, B)] {
  ...
  /** A view that zips elements of the underlying collection with the elements
    ...
    */
  @SerialVersionUID(3L)
  class ZipAll[A, B](underlying: SomeIterableOps[A],
                     other: Iterable[B],
                     thisElem: A,
                     thatElem: B)
      extends AbstractView[(A, B)] {
  ...
  @SerialVersionUID(3L)
  class Appended[+A](underlying: SomeIterableOps[A], elem: A)
      extends AbstractView[A] {
    def iterator: Iterator[A] =
      new Concat(underlying, new View.Single(elem)).iterator
    override def knownSize: Int = {
      val size = underlying.knownSize
      if (size >= 0) size + 1 else -1
    }
  ...
  @SerialVersionUID(3L)
  class Prepended[+A](elem: A, underlying: SomeIterableOps[A])
      extends AbstractView[A] {
    def iterator: Iterator[A] =
      new Concat(new View.Single(elem), underlying).iterator
    override def knownSize: Int = {
      val size = underlying.knownSize
      if (size >= 0) size + 1 else -1
    }
  ...
  @SerialVersionUID(3L)
  class Updated[A](underlying: SomeIterableOps[A], index: Int, elem: A)
      extends AbstractView[A] {
  ...
  @SerialVersionUID(3L)
  private[collection] class Patched[A](underlying: SomeIterableOps[A],
                                       from: Int,
                                       other: IterableOnce[A],
                                       replaced: Int)
      extends AbstractView[A] {
    def iterator: Iterator[A] =
      underlying.iterator.patch(from, other.iterator, replaced)
    override def knownSize: Int =
      if (underlying.knownSize == 0 && other.knownSize == 0) 0
      else super.knownSize
    override def isEmpty: Boolean =
      if (knownSize == 0) true else iterator.isEmpty
  }

  @SerialVersionUID(3L)
  class ZipWithIndex[A](underlying: SomeIterableOps[A])
      extends AbstractView[(A, Int)] {
  ...
  @SerialVersionUID(3L)
  class PadTo[A](underlying: SomeIterableOps[A], len: Int, elem: A)
      extends AbstractView[A] {
  ...
  private[collection] def takeRightIterator[A](it: Iterator[A],
                                               n: Int): Iterator[A] = {
    val k = it.knownSize
  ...
  private final class TakeRightIterator[A](
      private[this] var underlying: Iterator[A],
      maxlen: Int)
  ...
  private[collection] def dropRightIterator[A](it: Iterator[A],
                                               n: Int): Iterator[A] = {
    if (n <= 0) it
    else {
      val k = it.knownSize
  ...
  private final class DropRightIterator[A](
      private[this] var underlying: Iterator[A],
      maxlen: Int)
      extends AbstractIterator[A] {
    private[this] var len
      : Int = -1 // known size or -1 if the end of `underlying` has not been seen yet
    private[this] var pos: Int = 0
    private[this] var buf: ArrayBuffer[AnyRef] = _
    def init(): Unit = if (buf eq null) {
      buf = new ArrayBuffer[AnyRef](maxlen min 256)
