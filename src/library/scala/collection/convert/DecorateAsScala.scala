...
trait DecorateAsScala extends AsScalaConverters {
  ...
  /**
    ...
    * @see [[mapAsScalaMap]]
    */
  implicit def mapAsScalaMapConverter[K, V](
      m: ju.Map[K, V]): AsScala[mutable.Map[K, V]] =
  ...
  /**
    ...
    */
  implicit def mapAsScalaConcurrentMapConverter[K, V](
      m: juc.ConcurrentMap[K, V]): AsScala[concurrent.Map[K, V]] =
  ...
  /**
    ...
    */
  implicit def dictionaryAsScalaMapConverter[K, V](
      p: ju.Dictionary[K, V]): AsScala[mutable.Map[K, V]] =
