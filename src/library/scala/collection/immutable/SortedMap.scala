...
trait SortedMap[K, +V]
  ...
  override def withDefault[V1 >: V](d: K => V1): SortedMap[K, V1] =
    new SortedMap.WithDefault[K, V1](this, d)
  ...
  override def withDefaultValue[V1 >: V](d: V1): SortedMap[K, V1] =
    new SortedMap.WithDefault[K, V1](this, _ => d)
}
...
trait SortedMapOps[K,
  ...
  @`inline` final override def +[V1 >: V](kv: (K, V1)): CC[K, V1] =
    updated(kv._1, kv._2)

  override def transform[W](f: (K, V) => W): CC[K, W] =
    map({ case (k, v) => (k, f(k, v)) })
}

trait StrictOptimizedSortedMapOps[
    K,
    +V,
    +CC[X, +Y] <: Map[X, Y] with SortedMapOps[X, Y, CC, _],
    +C <: SortedMapOps[K, V, CC, C]]
  ...
  override def concat[V2 >: V](
      xs: collection.IterableOnce[(K, V2)]): CC[K, V2] = {
...
object SortedMap extends SortedMapFactory.Delegate[SortedMap](TreeMap) {
  ...
  final class WithDefault[K, +V](underlying: SortedMap[K, V],
                                 defaultValue: K => V)
    ...
    override def sortedMapFactory: SortedMapFactory[SortedMap] =
      underlying.sortedMapFactory

    def iteratorFrom(start: K): scala.collection.Iterator[(K, V)] =
      underlying.iteratorFrom(start)

    def keysIteratorFrom(start: K): scala.collection.Iterator[K] =
      underlying.keysIteratorFrom(start)
    ...
    override def removed(key: K): WithDefault[K, V] =
    ...
    override protected def fromSpecific(
        coll: scala.collection.IterableOnce[(K, V)] @uncheckedVariance)
      : WithDefault[K, V] =
    ...
    override protected def newSpecificBuilder
      ...
      SortedMap.newBuilder.mapResult((p: SortedMap[K, V]) =>
