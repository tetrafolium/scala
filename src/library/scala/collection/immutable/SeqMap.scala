...
object SeqMap extends MapFactory[SeqMap] {
  ...
  private object EmptyLinkedMap extends SeqMap[Any, Nothing] with Serializable {
    ...
    def updated[V1](key: Any, value: V1): SeqMap[Any, V1] =
      new SeqMap1(key, value)
    def removed(key: Any): SeqMap[Any, Nothing] = this
  }

  @SerialVersionUID(3L)
  private final class SeqMap1[K, +V](key1: K, value1: V)
      extends SeqMap[K, V]
      with Serializable {
  ...
  @SerialVersionUID(3L)
  private final class SeqMap2[K, +V](key1: K, value1: V, key2: K, value2: V)
      extends SeqMap[K, V]
      with Serializable {
  ...
  @SerialVersionUID(3L)
  private class SeqMap3[K, +V](key1: K,
                               value1: V,
                               key2: K,
                               value2: V,
                               key3: K,
    ...
    def iterator =
      ((key1, value1) :: (key2, value2) :: (key3, value3) :: Nil).iterator
    def updated[V1 >: V](key: K, value: V1): SeqMap[K, V1] =
  ...
  @SerialVersionUID(3L)
  private final class SeqMap4[K, +V](key1: K,
                                     value1: V,
                                     key2: K,
                                     value2: V,
                                     key3: K,
    ...
    def iterator =
      ((key1, value1) :: (key2, value2) :: (key3, value3) :: (key4, value4) :: Nil).iterator
    def updated[V1 >: V](key: K, value: V1): SeqMap[K, V1] =
      if (key == key1)
        new SeqMap4(key1, value, key2, value2, key3, value3, key4, value4)
      else if (key == key2)
        new SeqMap4(key1, value1, key2, value, key3, value3, key4, value4)
      else if (key == key3)
        new SeqMap4(key1, value1, key2, value2, key3, value, key4, value4)
      else if (key == key4)
        new SeqMap4(key1, value1, key2, value2, key3, value3, key4, value)
      else {
    ...
    def removed(key: K): SeqMap[K, V] =
      if (key == key1) new SeqMap3(key2, value2, key3, value3, key4, value4)
        ...
        new SeqMap3(key1, value1, key3, value3, key4, value4)
      else if (key == key3)
        new SeqMap3(key1, value1, key2, value2, key4, value4)
      else if (key == key4)
        new SeqMap3(key1, value1, key2, value2, key3, value3)
      else this
    override def foreach[U](f: ((K, V)) => U): Unit = {
