...
object scalac extends Command {
    ...
    DefinitionList(
      Definition(Mono(Argument("options")),
                 "Command line options. See " & Link(Bold("OPTIONS"),
                                                     "#options") &
                   " below."),
      Definition(Mono(Argument("source files")),
  ...
  val options = Section(
    ...
    Section(
      ...
      DefinitionList(
        ...
        Definition(CmdOptionBound("P:", Argument("plugin:opt")),
        ...
        Definition(CmdOption("d", Argument("directory|jar")),
                   "Specify where to place generated class files."),
        Definition(
          CmdOption("deprecation"),
          SeqPara("Emit warning and location for usages of deprecated APIs.",
        ...
        Definition(CmdOption("explaintypes"),
                   "Explain type errors in more detail."),
        Definition(CmdOption("extdirs", Argument("dirs")),
        ...
        Definition(CmdOption("javabootclasspath", Argument("path")),
                   "Override Java boot classpath."),
        Definition(CmdOption("javaextdirs", Argument("path")),
                   "Override Java extdirs classpath."),
        Definition(CmdOptionBound("language:", Argument("feature")),
                   "Enable one or more language features."),
        Definition(CmdOption("no-specialization"),
                   "Ignore " & MItalic("@specialize") & " annotations."),
        Definition(CmdOption("nobootcp"),
                   "Do not use the boot classpath for the Scala jar files."),
        Definition(CmdOption("nowarn"), "Generate no warnings"),
        Definition(
          CmdOption("optimise"),
          "Generates faster bytecode by applying optimisations to the program."),
        Definition(CmdOption("print"),
                   "Print program with all Scala-specific features removed."),
        Definition(CmdOption("sourcepath", Argument("path")),
                   "Specify location(s) of source files."),
        Definition(CmdOptionBound("target:", "{jvm-1.8}"),
                   SeqPara(Mono("\"jvm-1.8\"") & " target JVM 1.8 (default)")),
        Definition(CmdOption("toolcp", Argument("path")),
    ...
    Section(
      ...
      DefinitionList(
        ...
        Definition(CmdOption("Xdisable-assertions"),
        ...
        Definition(CmdOption("Xfatal-warnings"),
        ...
        Definition(CmdOption("Xlint"),
                   "Enable recommended additional warnings."),
        Definition(CmdOption("Xlog-free-terms"),
        ...
        Definition(CmdOptionBound("Xmacro-settings:", Argument("option")),
        ...
        Definition(
          ...
          "Warn about constructs whose behavior may have changed since" & Argument(
            "version") & "."),
        Definition(CmdOption("Xno-forwarders"),
        ...
        Definition(CmdOption("Xshow-class", Argument("class")),
                   "Show internal representation of class."),
        Definition(CmdOption("Xshow-object", Argument("object")),
                   "Show internal representation of object."),
        Definition(CmdOption("Xshow-phases"),
        ...
        Definition(CmdOption("Xsource-reader", Argument("classname")),
                   "Specify a custom method for reading source files."),
        Definition(CmdOption("Xstrict-inference"),
    ...
    Section(
      "Compilation Phases",
      DefinitionList(
        Definition(MItalic("parser"),
                   "parse source into ASTs, perform simple desugaring"),
        Definition(MItalic("namer"),
        ...
        Definition(MItalic("explicitouter"),
                   "this refs to outer pointers, translate patterns"),
        Definition(MItalic("erasure"),
        ...
        Definition(MItalic("constructors"),
        ...
        Definition(MItalic("inlineHandlers"),
                   "optimization: inline exception handlers"),
        Definition(MItalic("closelim"),
                   "optimization: eliminate uncalled closures"),
        Definition(MItalic("constopt"),
  ...
  val examples = Section(
    "EXAMPLES",
    DefinitionList(
      Definition("Compile a Scala program to the current directory",
                 CmdLine("HelloWorld")),
      Definition("Compile a Scala program to the destination directory " &
                   MBold("classes"),
