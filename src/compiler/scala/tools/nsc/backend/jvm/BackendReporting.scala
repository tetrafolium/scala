...
object BackendReporting {
  ...
  object OptimizerWarning {
    ...
    implicit val emptyOptimizerWarning: OptimizerWarning =
      new OptimizerWarning {
    ...
    def emitWarning(settings: CompilerSettings): Boolean = this match {
      ...
      case m @ MethodNotFound(_, _, _, missing) =>
        if (m.isArrayMethod) false
          ...
          settings.optWarningNoInlineMissingBytecode || missing.exists(
  ...
  final case class ClassNotFound(internalName: InternalName,
  ...
  final case class FieldNotFound(name: String,
                                 descriptor: String,
  ...
  final case class NoClassBTypeInfoMissingBytecode(
      cause: MissingBytecodeWarning)
      extends NoClassBTypeInfo
  final case class NoClassBTypeInfoClassSymbolInfoFailedSI9111(
  ...
  sealed trait CalleeInfoWarning extends OptimizerWarning {
    ...
    def emitWarning(settings: CompilerSettings): Boolean = this match {
      ...
      case MethodInlineInfoMissing(_, _, _, Some(cause)) =>
        cause.emitWarning(settings)
      case MethodInlineInfoMissing(_, _, _, None) =>
        settings.optWarningNoInlineMissingBytecode
  ...
  final case class MethodInlineInfoIncomplete(declarationClass: InternalName,
                                              name: String,
                                              descriptor: String,
  ...
  final case class MethodInlineInfoMissing(
      ...
      extends CalleeInfoWarning
  final case class MethodInlineInfoError(declarationClass: InternalName,
                                         name: String,
                                         descriptor: String,
  ...
  sealed trait CannotInlineWarning extends OptimizerWarning {
    ...
    def calleeMethodSig =
      BackendReporting.methodSignature(calleeDeclarationClass, name, descriptor)
    ...
    override def toString = {
      ...
      val reason = this match {
        ...
        case IllegalAccessInstructions(_,
                                       _,
                                       _,
                                       _,
                                       callsiteClass,
  ...
  final case class CalleeNotFinal(calleeDeclarationClass: InternalName,
                                  name: String,
                                  descriptor: String,
  ...
  final case class MethodWithHandlerCalledOnNonEmptyStack(
      ...
      callsiteDesc: String)
      extends CannotInlineWarning
  final case class SynchronizedMethod(calleeDeclarationClass: InternalName,
                                      name: String,
                                      descriptor: String,
                                      annotatedInline: Boolean)
      extends CannotInlineWarning
  final case class StrictfpMismatch(calleeDeclarationClass: InternalName,
                                    name: String,
                                    descriptor: String,
                                    annotatedInline: Boolean,
                                    callsiteClass: InternalName,
                                    ...
                                    callsiteDesc: String)
      extends CannotInlineWarning
  case class ResultingMethodTooLarge(calleeDeclarationClass: InternalName,
                                     name: String,
                                     descriptor: String,
                                     annotatedInline: Boolean,
                                     callsiteClass: InternalName,
  ...
  final case class RewriteClosureAccessCheckFailed(pos: Position,
                                                   cause: OptimizerWarning)
      extends RewriteClosureApplyToClosureBodyFailed
  final case class RewriteClosureIllegalAccess(pos: Position,
                                               callsiteClass: InternalName)
      extends RewriteClosureApplyToClosureBodyFailed
  ...
  sealed trait ClassInlineInfoWarning extends OptimizerWarning {
    ...
    def emitWarning(settings: CompilerSettings): Boolean = this match {
      case NoInlineInfoAttribute(_) =>
        settings.optWarningNoInlineMissingScalaInlineInfoAttr
      case ClassNotFoundWhenBuildingInlineInfoFromSymbol(cause) =>
        cause.emitWarning(settings)
      case ClassSymbolInfoFailureSI9111(_) =>
        settings.optWarningNoInlineMissingBytecode
  ...
  final case class NoInlineInfoAttribute(internalName: InternalName)
      extends ClassInlineInfoWarning
  final case class ClassSymbolInfoFailureSI9111(classFullName: String)
      extends ClassInlineInfoWarning
  final case class ClassNotFoundWhenBuildingInlineInfoFromSymbol(
      missingClass: ClassNotFound)
      extends ClassInlineInfoWarning
  final case class UnknownScalaInlineInfoVersion(internalName: InternalName,
                                                 version: Int)
      extends ClassInlineInfoWarning
}
