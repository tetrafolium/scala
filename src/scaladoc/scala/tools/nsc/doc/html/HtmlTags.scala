...
object HtmlTags {
  ...
  trait Elem extends Product {
    ...
    def attribs: Seq[(String, String)] = {
      attribNames
        .lazyZip(attribValues)
        .collect { case (k, v) if k != "elems" && v != null => (k, v.toString) }
        .toSeq
    }
  }
  ...
  case class Link(href: String,
      ...
      extends Elem
      with WithoutElems
  case class Script(`type`: String = null,
                    src: String = null,
                    id: String = null,
                    elems: Elems = NoElems)
      extends Elem // TODO: write script body as raw
  case class Meta(`http-equiv`: String = null,
                  content: String = null,
                  name: String = null)
      extends Elem
      with WithoutElems
  ...
  case class H(i: Int, elems: Elems, id: String = null, `class`: String = null)
      extends Elem {
  ...
  case class A(elems: Elems = NoElems,
               href: String = null,
               target: String = null,
               name: String = null,
               id: String = null,
               ...
               `class`: String = null)
      extends Elem
  case class Span(elems: Elems = NoElems,
                  name: String = null,
                  id: String = null,
                  `class`: String = null,
                  title: String = null)
      extends Elem
  case class Input(autocapitalize: String = null,
      ...
      extends Elem
      with WithoutElems
  case class Div(elems: Elems = NoElems,
                 id: String = null,
                 name: String = null,
                 style: String = null,
                 `class`: String = null)
      extends Elem
  case class P(elems: Elems, id: String = null, `class`: String = null)
      extends Elem
  case class Button(elems: Elems,
                    title: String = null,
                    id: String = null,
                    `class`: String = null)
      extends Elem
  case class B(elems: Elems) extends Elem
  case class I(elems: Elems, id: String = null, `class`: String = null)
      extends Elem
  ...
  case class Ol(elems: Elems, id: String = null, `class`: String = null)
      extends Elem
  case class Li(elems: Elems,
                `class`: String = null,
                name: String = null,
                `data-hidden`: String = null,
                group: String = null,
                fullComment: String = null,
                `data-isabs`: String = null,
                visbl: String = null)
      extends Elem
  ...
  case class Svg(elems: Elems = Nil,
                 id: String = null,
                 `class`: String = null,
                 width: String,
                 height: String)
  ...
  case class Table(thead: THead = null,
                   tbody: TBody = null,
                   `class`: String = null)
      extends Elem { def elems = (thead :: tbody :: Nil).filterNot(_ == null) }
