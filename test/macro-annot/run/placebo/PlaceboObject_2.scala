...
@placebo object CPreToplevelNocomp {
...
class PlaceboClass {
  ...
  @placebo object CPreMemberNocomp {
    override def toString = "CPreMemberNocomp"
  }
  ...
  @placebo object CPostMemberNocomp {
  ...
  // @Test
  def combo: Unit = {
    @placebo object CPreLocalNocomp {
      override def toString = "CPreLocalNocomp"
    }
    ...
    @placebo object CPostLocalNocomp {
...
@placebo object CPostToplevelNocomp {
