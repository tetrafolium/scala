...
class BitManipulationBenchmark {
  val powersOfTwo = Array(1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048,
  ...
  private def withIntegerBitCount(v: Int) =
    Integer.SIZE - Integer.bitCount(v - 1)
  ...
  private def withIntegerNumberOfLeadingZeros(v: Int) =
    Integer.numberOfLeadingZeros(v - 1)
  ...
  private val multiplyDeBruijnBitPosition2 =
    Array(32, 31, 4, 30, 3, 18, 8, 29, 2, 10, 12, 17, 7, 15, 28, 24, 1, 5, 19,
      9, 11, 13, 16, 25, 6, 20, 14, 26, 21, 27, 22, 23)

  private def with2DeBruijn(v: Int) =
  ...
  private def withBinSearch(v: Int) =
    if (v < 65536)
      ...
      if (v < 1048576)
        if (v < 262144) if (v == 65536) 16 else 15
        else if (v == 262144) 14
        else 13
      else if (v < 4194304) if (v == 1048576) 12 else 11
      else if (v == 4194304) 10
      else 9
    else if (v < 268435456)
      if (v < 67108864) if (v == 16777216) 8 else 7
      else if (v == 67108864) 6
      else 5
    else if (v < 1073741824) if (v == 268435456) 4 else 3
    else if (v == 1073741824) 2
    else 1
