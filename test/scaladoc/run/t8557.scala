...
object Test extends ScaladocModelTest {
  ...
  override def scaladocSettings = {
    val samplePath = getClass.getClassLoader
    ...
    val scalaLibPath = if (samplePath.contains("!")) { // in scala-library.jar
      ...
      p.replace("/pack/lib/scala-library.jar",
                "/pack/bin/../lib/scala-library.jar")
  ...
  def testModel(rootPackage: Package) = {
    ...
    val links =
      countLinks(a.comment.get, _.link.isInstanceOf[LinkToExternalTpl])
