...
package test {
  ...
  class Baz extends Bar {
    def f =
      "$bar is private, shall we warn just in case?" // no longer a warning, private members aren't inherited!
  }
  class G {
...
package curry {
  class A {
    ...
    def groucho(): Int = 5
    def dingo()()()()()(): Int =
      5 // kind of nuts this can be evaluated with just 'dingo', but okay
