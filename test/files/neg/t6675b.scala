...
class E {
  def f1 = (Left((0, 0)): Either[(Int, Int), (Int, Int)]) match {
    case LeftOrRight(a) => a
  } // warn
  def f2 = (Left((0, 0)): Either[(Int, Int), (Int, Int)]) match {
    case LeftOrRight((a, b)) => a
  } // no warn
  def f3 = (Left((0, 0)): Either[(Int, Int), (Int, Int)]) match {
    case LeftOrRight((a, b, c)) => a
  } // fail
}
...
class B {
  ...
  def f3[A](x: A) = (Left(x -> x): Either[(A, A), (A, A)]) match {
    case LeftOrRight((a, b)) => a
  } // no warn
...
class C {
  ...
  def f2 = (Left((0, 0)): Either[(Int, Int), (Int, Int)]) match {
    case NativelyTwo((a, b)) => a
  } // no warn
  def f3 = (Left((0, 0)): Either[(Int, Int), (Int, Int)]) match {
    case NativelyTwo((a, b, c)) => a
  } // fail
}
