class A[U] {
  @annotation.varargs
  def m1[T](a: T*): T = a.head
  @annotation.varargs
  def m2[T <: AnyRef](a: T*): T = a.head
  @annotation.varargs
  def m3[T <: AnyVal](a: T*): T = a.head
  @annotation.varargs
  def m4[T <: Int](a: T*): T = a.head
  @annotation.varargs
  def m5[T <: String](a: T*): T = a.head
  @annotation.varargs
  def m6(a: String*): String = a.head
  @annotation.varargs
  def m7(a: Int*): Int = a.head
  @annotation.varargs
  def m8(a: U*): U = a.head
...
object Test extends App {
  ...
  def sig(method: String, tp: Class[_]) =
    a.getDeclaredMethod(method, tp).toString
  def genSig(method: String, tp: Class[_]) =
    a.getDeclaredMethod(method, tp).toGenericString
  def bound(method: String, tp: Class[_]) = {
    ...
    m.getGenericParameterTypes.apply(0) match {
      ...
      case gat: java.lang.reflect.GenericArrayType =>
        val compTp = gat.getGenericComponentType
          .asInstanceOf[java.lang.reflect.TypeVariable[_]]
  ...
  check(sig("m1", sq),
        "public java.lang.Object A.m1(scala.collection.immutable.Seq)")
  check(sig("m2", sq),
        "public java.lang.Object A.m2(scala.collection.immutable.Seq)")
  check(sig("m3", sq),
        "public java.lang.Object A.m3(scala.collection.immutable.Seq)")
  check(sig("m4", sq), "public int A.m4(scala.collection.immutable.Seq)")
  check(sig("m5", sq),
        "public java.lang.String A.m5(scala.collection.immutable.Seq)")
  check(sig("m6", sq),
        "public java.lang.String A.m6(scala.collection.immutable.Seq)")
  check(sig("m7", sq), "public int A.m7(scala.collection.immutable.Seq)")
  check(sig("m8", sq),
        "public java.lang.Object A.m8(scala.collection.immutable.Seq)")

  check(genSig("m1", sq),
        "public <T> T A.m1(scala.collection.immutable.Seq<T>)")
  check(genSig("m2", sq),
        "public <T> T A.m2(scala.collection.immutable.Seq<T>)")
  check(genSig("m3", sq),
        "public <T> T A.m3(scala.collection.immutable.Seq<T>)")
  ...
  check(genSig("m4", sq),
        "public <T> T A.m4(scala.collection.immutable.Seq<T>)")
  check(genSig("m5", sq),
        "public <T> T A.m5(scala.collection.immutable.Seq<T>)")
  check(
    genSig("m6", sq),
    "public java.lang.String A.m6(scala.collection.immutable.Seq<java.lang.String>)")
  check(genSig("m7", sq),
        "public int A.m7(scala.collection.immutable.Seq<java.lang.Object>)")
