...
object Test1_scala {
  ...
  try {
    ...
    println(
      "e1 equals _e1: " + (e1 equals _e1) + ", _e1 equals e1: " + (_e1 equals e1))
    println()
    ...
    println(
      "x7 equals y7: " + (x7 equals y7) + ", y7 equals x7: " + (y7 equals x7))
    println()
    ...
    println(
      "x8 equals y8: " + (x8 equals y8) + ", y8 equals x8: " + (y8 equals x8))
    println()
    ...
    println(
      "x9 equals y9: " + (x9 equals y9) + ", y9 equals x9: " + (y9 equals x9))
    println()
    ...
    println(
      "x10 equals y10: " + (x10 equals y10) + ", y10 equals x10: " + (y10 equals x10))
    println()

    println("x9 eq x10: " + (x9 eq x10) + ", x10 eq x9: " + (x10 eq x9))
    println(
      "x9 equals x10: " + (x9 equals x10) + ", x10 equals x9: " + (x10 equals x9))
    println("x9 eq y10: " + (x9 eq y10) + ", y10 eq x9: " + (y10 eq x9))
    println(
      "x9 equals y10: " + (x9 equals y10) + ", y10 equals x9: " + (y10 equals x9))
    println()
    ...
    println(
      "xs0 equals _xs0: " + (xs0 equals _xs0) + ", _xs0 equals xs0: " + (_xs0 equals xs0))
    println()
    ...
    println(
      "o2 equals _o2: " + (o2 equals _o2) + ", _o2 equals o2: " + (_o2 equals o2))
    println()
    /*
    // Responder
    ...
    println(
      "s1 equals _s1: " + (s1 equals _s1) + ", _s1 equals s1: " + (_s1 equals s1))
    println()
    ...
    println(
      "t1 equals _t1: " + (t1 equals _t1) + ", _t1 equals t1: " + (_t1 equals t1))
    println()
  } catch {
    case e: Exception =>
...
object Test2_immutable {
  ...
  try {
    ...
    // ListMap
    val lm1 = new ListMap[String, Int] ++ List("buffers" -> 20,
                                               "layers" -> 2,
                                               "title" -> 3)
...
object Test3_mutable {
  ...
  try {
    ...
    // concurrent.TrieMap
    val ct1 = TrieMap[Int, String]() ++= Array(1 -> "one",
                                               2 -> "two",
                                               3 -> "three")
