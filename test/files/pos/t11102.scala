...
abstract class ImmutableCons extends ImmutableSeq {
  def first: Int
...
abstract class MutableCons extends MutableSeq {
  def first: Int
...
/**
  * collection.Seq
  */
abstract class CollectionSeq extends collection.Seq[Int] with UnimplementedSeq
...
abstract class CollectionCons extends CollectionSeq {
  def first: Int
...
/**
  * scala.Seq
  */
abstract class ScalaSeq extends collection.Seq[Int] with UnimplementedSeq
...
abstract class ScalaCons extends ScalaSeq {
  def first: Int
...
/**
  * Seq
  */
abstract class DefaultSeq extends Seq[Int] with UnimplementedSeq
...
abstract class DefaultCons extends DefaultSeq {
  def first: Int
