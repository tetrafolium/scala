...
class Test {
  trait Tree
  def foo(b: Boolean,
          buf: collection.mutable.ArrayBuffer[Any],
          acc: StringBuilder) = if (b) buf else acc
  ...
  def bar(a: Boolean,
          b: collection.mutable.Set[Any],
          c: collection.mutable.ListBuffer[Any]) = if (a) b else c
  def baz(a: Boolean,
          b: scala.collection.mutable.SetOps[Any,
                                             scala.collection.mutable.Set,
                                             scala.collection.mutable.Set[Any]],
          c: scala.collection.mutable.Buffer[Any]) = if (a) b else c
}
