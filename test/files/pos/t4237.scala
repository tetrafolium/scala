class A {
  ...
  (new {
    def field(implicit i: Int) = 0; def field_=(i: Int)(implicit j: Imp) = ()
  }).field = 5
  (new {
    def field(implicit i: Int) = 0;
    def field_=[T <: Imp](i: Int)(implicit j: T) = ()
  }).field = 5
  // was reassignment to val
  (new {
    def field[T](implicit ts: List[T]) = 0;
    def field_=[T](i: Int)(implicit ts: List[T]) = ()
  }).field = 5
  (new {
    def field[T](implicit ts: List[T]) = 0;
    def field_=[T](i: T)(implicit ts: List[T]) = ()
  }).field = 5
}
