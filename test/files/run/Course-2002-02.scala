...
object M9 {
  ...
  val pi = 2 * product(x => 2 * x * 2 * x)(1, 20) / product(
...
object MC {
  ...
  Console.println("1 + 2 + .. + 5 = " + sum(x => x)(1, 5));
  Console.println("1 * 2 * .. * 5 = " + product(x => x)(1, 5));
  Console.println;

  Console.println("1^2 + 2^2 + .. + 5^2 = " + sum(x => x * x)(1, 5));
  Console.println("1^2 * 2^2 * .. * 5^2 = " + product(x => x * x)(1, 5));
  Console.println;

  Console.println("factorial(0) = " + factorial(0))
  Console.println("factorial(1) = " + factorial(1))
  Console.println("factorial(2) = " + factorial(2))
  Console.println("factorial(3) = " + factorial(3))
...
object ME {
  ...
  def product: (Int => Double) => (Int, Int) => Double =
    reduce((x, y) => x * y, 1);
