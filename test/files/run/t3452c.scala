...
trait E1[B, C] extends Base[String, B, C] {
  ...
  override def h(x: String, y: B, z: C) = g(x, y, z)
}
trait E2[A, B] extends Base[A, B, String] {
  def f(x: A, y: B, z: String): Unit;
  override def h(x: A, y: B, z: String) = g(x, y, z)
}
trait E3[A, C] extends Base[A, String, C] {
  def f(x: A, y: String, z: C): Unit;
  override def h(x: A, y: String, z: C) = g(x, y, z)
}
trait E4[A] extends Base[A, String, String] {
  def f(x: A, y: String, z: String): Unit;
  override def h(x: A, y: String, z: String) = g(x, y, z)
}
trait E5[B] extends Base[String, B, String] {
  def f(x: String, y: B, z: String): Unit;
  override def h(x: String, y: B, z: String) = g(x, y, z)
}
trait E6[C] extends Base[String, String, C] {
  def f(x: String, y: String, z: C): Unit;
  override def h(x: String, y: String, z: C) = g(x, y, z)
}
trait E7 extends Base[String, String, String] {
  def f(x: String, y: String, z: String): Unit;
  override def h(x: String, y: String, z: String) = g(x, y, z)
}

trait F1[B, C] extends Base[String, B, C] {
  def f(x: String, y: B, z: C): Unit = println(x.length)
}
trait F2[A, B] extends Base[A, B, String] {
  def f(x: A, y: B, z: String): Unit = println(z.length)
}
trait F3[A, C] extends Base[A, String, C] {
  def f(x: A, y: String, z: C): Unit = println(y.length)
}
trait F4[A] extends Base[A, String, String] {
  def f(x: A, y: String, z: String): Unit = println(y.length)
}
trait F5[B] extends Base[String, B, String] {
  def f(x: String, y: B, z: String): Unit = println(x.length)
}
trait F6[C] extends Base[String, String, C] {
  def f(x: String, y: String, z: C): Unit = println(x.length)
}
trait F7 extends Base[String, String, String] {
  def f(x: String, y: String, z: String): Unit = println(x.length)
}
