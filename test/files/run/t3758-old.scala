...
object Test {
  def main(args: Array[String]): Unit = {
    assert(
      implicitly[ClassManifest[Array[String]]].typeArguments contains implicitly[
        ClassManifest[String]])
    assert(
      implicitly[ClassManifest[Array[Int]]].typeArguments contains implicitly[
        ClassManifest[Int]])
    assert(
      implicitly[ClassManifest[Array[Float]]].typeArguments contains implicitly[
        ClassManifest[Float]])
