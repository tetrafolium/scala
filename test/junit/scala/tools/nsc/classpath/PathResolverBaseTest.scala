...
class PathResolverBaseTest {
  ...
  private val packagesToTest =
    List(ClassPath.RootPackage, "scala", "scala.reflect", "scala.reflect.io")
  ...
  def testEntriesFromListOperationAgainstSeparateMethods: Unit = {
    ...
    def compareEntriesInPackage(inPackage: String): Unit = {
      ...
      val ClassPathEntries(packagesFromList, classesAndSourcesFromList) =
        classPath.list(inPackage)
