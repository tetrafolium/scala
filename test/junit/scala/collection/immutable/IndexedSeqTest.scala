...
class IndexedSeqTest extends AllocationTest {
  ...
  @Test def testEqualsSimple: Unit = {
    ...
    assertTrue(
      Vector(1, 2, 3, 4, 5, 6, 7, 8, 9) == Vector(1, 2, 3, 4, 5, 6, 7, 8, 9))

    assertTrue(ArraySeq.empty == ArraySeq.empty)
    assertTrue(ArraySeq(1, 2, 3) == ArraySeq(1, 2, 3))
    assertTrue(
      ArraySeq(1, 2, 3, 4, 5, 6, 7, 8, 9) == ArraySeq(1, 2, 3, 4, 5, 6, 7, 8,
        9))
  }
  ...
  @Test def testNotEqualsSimple1: Unit = {
    ...
    assertTrue(
      Vector(1, 2, 3, 4, 5, 6, 7, 8, 9) != Vector(1, 2, 3, 4, 5, 6, 7, 8, 99))
  }
  ...
  @Test def testNotEqualsSimple3: Unit = {
    ...
    assertTrue(
      ArraySeq(1, 2, 3, 4, 5, 6, 7, 8, 9) != Vector(1, 2, 3, 4, 5, 6, 7, 8, 99))
  }

  @Test def testNotEqualsEdges: Unit = {
    assertTrue(
      ArraySeq(1, 2, 3, 4, 5, 6, 7, 8, 9) != Vector(10, 2, 3, 4, 5, 6, 7, 8, 9))
    assertTrue(
      ArraySeq(1, 2, 3, 4, 5, 6, 7, 8, 9) != Vector(1, 20, 3, 4, 5, 6, 7, 8, 9))
    assertTrue(
      ArraySeq(1, 2, 3, 4, 5, 6, 7, 8, 9) != Vector(1, 2, 30, 4, 5, 6, 7, 8, 9))
    assertTrue(
      ArraySeq(1, 2, 3, 4, 5, 6, 7, 8, 9) != Vector(1, 2, 3, 40, 5, 6, 7, 8, 9))
    assertTrue(
      ArraySeq(1, 2, 3, 4, 5, 6, 7, 8, 9) != Vector(1, 2, 3, 4, 50, 6, 7, 8, 9))
    assertTrue(
      ArraySeq(1, 2, 3, 4, 5, 6, 7, 8, 9) != Vector(1, 2, 3, 4, 5, 60, 7, 8, 9))
    assertTrue(
      ArraySeq(1, 2, 3, 4, 5, 6, 7, 8, 9) != Vector(1, 2, 3, 4, 5, 6, 70, 8, 9))
    assertTrue(
      ArraySeq(1, 2, 3, 4, 5, 6, 7, 8, 9) != Vector(1, 2, 3, 4, 5, 6, 7, 80, 9))
    assertTrue(
      ArraySeq(1, 2, 3, 4, 5, 6, 7, 8, 9) != Vector(1, 2, 3, 4, 5, 6, 7, 8, 90))
  }
  ...
  @Test def testEqualsSimpleNonAllocatingDiffInFirstFew: Unit = {
    nonAllocatingEqual(false,
                       Vector(1, 2, 3, 14, 5, 6, 7, 8, 9),
                       Vector(1, 2, 3, 4, 5, 6, 7, 8, 9))
    nonAllocatingEqual(false,
                       ArraySeq(1, 2, 3, 14, 5, 6, 7, 8, 9),
                       ArraySeq(1, 2, 3, 4, 5, 6, 7, 8, 9))
    nonAllocatingEqual(false,
                       Vector(1, 2, 3, 14, 5, 6, 7, 8, 9),
                       ArraySeq(1, 2, 3, 4, 5, 6, 7, 8, 9))
  ...
  @Test def testforwardSliceEquals(): Unit = {
    ...
    assertSameElements(6 to 12 by 2 toList,
                       generateTestIter slice (3, 7) map (2 * _))
    assertSameElements(6 to 12 by 2 toList,
                       generateTestIter map (2 * _) slice (3, 7))
    ...
    assertSameElements(4 to 5 toList,
                       generateTestIter slice (3, 7) slice (1, 3))
    assertSameElements(4 to 6 toList,
                       generateTestIter slice (3, 7) slice (1, 10))
  }
  ...
  @Test def testbackwardSliceEquals(): Unit = {
    ...
    assertSameElements(14 to 8 by -2 toList,
                       generateTestIter slice (3, 7) map (2 * _))
    assertSameElements(14 to 8 by -2 toList,
                       generateTestIter map (2 * _) slice (3, 7))
    assertSameElements(6 to 4 by -1 toList,
                       generateTestIter slice (3, 7) drop 1)
    assertSameElements(6 to 3 by -1 toList,
                       generateTestIter drop 1 slice (3, 7))
    assertSameElements(6 to 5 by -1 toList,
                       generateTestIter slice (3, 7) slice (1, 3))
    assertSameElements(6 to 4 by -1 toList,
                       generateTestIter slice (3, 7) slice (1, 10))
  }
