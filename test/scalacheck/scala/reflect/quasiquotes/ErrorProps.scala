...
object ErrorProps extends QuasiquoteProperties("errors") {
  ...
  property("scala/bug#8211: check unbound placeholder parameters") =
    fails("unbound placeholder parameter", """
      q"_"
    """)

  property("scala/bug#8211: check unbound wildcard types") =
    fails("unbound wildcard type", """
      tq"_"
    """)

  property(
    "scala/bug#8420: don't crash on splicing of non-unliftable native type (1)") =
    fails(
  ...
  property(
    "scala/bug#8420: don't crash on splicing of non-unliftable native type (2)") =
    fails(
  ...
  property(
    "scala/bug#8420: don't crash on splicing of non-unliftable native type (3)") =
    fails(
  ...
  property(
    "scala/bug#8451 construction: disallow everything except for constructor calls in secondary constructor bodies") =
  ...
  property(
    "scala/bug#8451 deconstruction: disallow everything except for constructor calls in secondary constructor bodies") =
    fails("'this' expected but unquotee found",
          """
