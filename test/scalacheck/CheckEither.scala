...
object CheckEitherTest extends Properties("Either") {
  ...
  val prop_either1 = forAll(
    (n: Int) => Left(n).fold(x => x, b => sys.error("fail")) == n)
  ...
  val prop_flatMapRightIdentity = forAll(
    (e: Either[Int, Int]) => e.flatMap(Right(_)) == e)
  ...
  val tests = List(
    ...
    ("Left.prop_flatMapLeftIdentity",
     CheckLeftProjection.prop_flatMapLeftIdentity),
    ...
    ("Right.prop_flatMapLeftIdentity",
     CheckRightProjection.prop_flatMapLeftIdentity),
    ("Right.prop_flatMapRightIdentity",
     CheckRightProjection.prop_flatMapRightIdentity),
    ("Right.prop_flatMapComposition",
     CheckRightProjection.prop_flatMapComposition),
